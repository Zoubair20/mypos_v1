            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{route('dashboard.users.update', $user->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <img src="{{$user->image_path}}" style="width: 100px" alt="" class="img-thumbnail image-preview">
                        </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="users">
                                    <label> <input type="checkbox" name="permissions[]"
                                                   {{$user->hasPermission('create_users') ? 'checked' : '' }}
                                                   value="create_users">@lang('site.create') </label>
                                    <label> <input type="checkbox" name="permissions[]"
                                                   {{$user->hasPermission('read_users') ? 'checked' : '' }}
                                                   value="read_users">@lang('site.read') </label>
                                    <label> <input type="checkbox" name="permissions[]"
                                                   {{$user->hasPermission('update_users') ? 'checked' : '' }}
